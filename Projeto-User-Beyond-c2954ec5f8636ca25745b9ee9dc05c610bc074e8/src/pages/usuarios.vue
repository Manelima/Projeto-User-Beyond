<template>
  <div>
    <v-app-bar color="red lighten-1 text-center">
      ...
      <v-spacer></v-spacer>
      <v-btn @click="navegar('/')">Retornar a Home</v-btn>
      <v-btn @click="navegar('/Cursos')">Ir para Cursos</v-btn>
      <v-btn @click="navegar('/Calendario')">Ir para Calendário</v-btn>
      <v-btn @click="navegar('/Forum')">Ir para o Fórum</v-btn>
      <v-btn @click="navegar('/Biblioteca')">Ir para Biblioteca</v-btn>
    </v-app-bar>
